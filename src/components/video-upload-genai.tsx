...
import { Upload, Play, CheckCircle, AlertCircle, X, FileVideo, Sparkles, Check } from 'lucide-react';
  ...
  const handleSubmitSelections = async () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        // Optionally redirect to the video page or dashboard
